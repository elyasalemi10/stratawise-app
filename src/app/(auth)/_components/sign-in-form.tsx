...
// Shared sign-in form rendered both at "/" (canonical) and "/sign-in" (kept
// alive for bookmarks and the post-redirect URLs scattered across the app).
// Both routes use the (auth) two-panel layout.
        ...
        <div className="space-y-1.5">
          <div className="flex items-center justify-between">
            ...
            <Link
              ...
              className="text-xs font-medium text-[color:var(--brand-gold)] hover:underline"
            >
              Forgot password?
            </Link>
          </div>
