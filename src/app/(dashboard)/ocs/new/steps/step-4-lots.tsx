...
import { step4Schema, type Step4Values } from "@/lib/validations/oc-wizard";
import { updateOCStep4 } from "../actions";
...
export function Step4Lots({
  ...
  // When editing a oc mid-setup, pre-fill invitee contact details
  ...
  async function onSubmit(data: Step4Values) {
    setPending(true);
    const result = await updateOCStep4(ocId, {
      ...data,
