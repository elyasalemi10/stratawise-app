    ...
    <div className="space-y-6">
      <Tabs value={activeTab} onValueChange={switchTab}>
        <div className="flex items-center justify-between border-b border-border">
          <TabsList
            variant="line"
            className="h-auto flex-wrap justify-start gap-0 border-0 bg-transparent p-0"
          >
            {accounts.map((a) => (
              <TabsTrigger
                key={a.id}
          ...
          <button
            ...
            className="ml-2 mr-1 inline-flex h-8 w-8 items-center justify-center rounded-md text-muted-foreground hover:bg-muted hover:text-foreground cursor-pointer"
          >
            ...
            <TabsContent key={a.id} value={a.id} className="mt-4">
              <div className="rounded-md border border-border bg-card p-5 space-y-5">
                <div className="flex items-center justify-between gap-4">
                  ...
                  <Button onClick={() => setImportTarget(a)} className="w-[120px] justify-center">
