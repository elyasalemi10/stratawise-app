...
// ----------------------------------------------------------------------------
// Appears at the top of the bank-account page when the oc has a
...
export function GapReconciliationBanner({
  ...
  const load = useCallback(async () => {
    const r = await getActiveGapReportForOC(ocId);
    setReport(r);
    setLoaded(true);
  }, [ocId]);
    ...
    >
      ...
      <div className="min-w-0 flex-1">
        ...
        <div className="mt-3 flex flex-wrap gap-2">
          <Link
            href={`/ocs/${ocCode}/reconciliation/gap-reports/${report.id}`}
