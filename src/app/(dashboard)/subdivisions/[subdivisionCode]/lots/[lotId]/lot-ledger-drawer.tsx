                    ...
                    sourceLink.levyBatchId && (
                      <>
                        ...
                        <div className="flex items-center justify-between rounded-md border border-border bg-muted/30 p-3">
                          ...
                          <Link
                            href={`/subdivisions/${subdivisionCode}/levies/${sourceLink.levyBatchId}`}
                    ...
                    <>
                      ...
                      {sourceLink.bankTxnId ? (
                        <div className="flex items-center justify-between rounded-md border border-border bg-muted/30 p-3">
                          ...
                          <Link
                            href={`/subdivisions/${subdivisionCode}/reconciliation/${sourceLink.bankTxnId}`}
                            className="flex items-center gap-1 text-xs text-primary hover:underline"
                          >
                            View match
                            <ExternalLink className="h-3 w-3" />
                        ...
                        <div className="flex items-center justify-between rounded-md border border-border bg-muted/30 p-3">
                          ...
                          <Link
                            href={`/subdivisions/${subdivisionCode}/bank-account`}
                            className="flex items-center gap-1 text-xs text-primary hover:underline"
                          >
                            View receipts
                            <ExternalLink className="h-3 w-3" />
