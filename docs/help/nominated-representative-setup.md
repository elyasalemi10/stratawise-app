...
"Connect bank feed" flow in StrataWise and your OC's
...
Once granted, consent lasts 12 months. StrataWise will remind
...
but StrataWise still shows "Not connected", check that the bank account BSB
and account number in StrataWise exactly match the account you nominated for
